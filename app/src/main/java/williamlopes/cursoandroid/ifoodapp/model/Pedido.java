...
public class Pedido {
    ...
    public void salvar(){
        ...
        DatabaseReference firebaseRef = ConfiguracaoFirebase.getFirebase();
        DatabaseReference pedidoRef = firebaseRef
                .child("pedidos_usuario") //Este nó é temporário que irei utilizar para salvar os dados do usuario quando este confirmar o pedido, gerando o nó "pedidos" e vai cair para a empresa
                .child( getIdEmpresa() )
                .child( getIdUsuario() );
